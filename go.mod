...
// used only for testing https://github.com/openshift/library-go/pull/1410
replace github.com/openshift/library-go => github.com/dobsonj/library-go v0.0.0-20221014195822-e844d39297c9
